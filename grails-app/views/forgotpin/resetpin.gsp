...
<html>
  <head>
      <title><g:message code="com.sungardhe.banner.forgotpin.resetpassword.title"/></title>
                  ...
                  <div class="main-wrapper" >
                      ...
                      <form action="${postBackUrl}" method="post" id="resetPinForm">
                          <table cellpadding="5" cellspacing="10" class="input-table">
                             ...
                             <tr><td class="tabledata" colspan="2"><g:message code="com.sungardhe.banner.forgotpin.resetpassword.message"/></td></tr>
                             <tr><td class="tabletext"> <g:message code="com.sungardhe.banner.forgotpin.newpassword"/>:</td><td class="tabledata"><input type="password" name="password" class="input-text"/> </td></tr>
                             <tr><td class="tabletext"> <g:message code="com.sungardhe.banner.forgotpin.repassword" c/> :</td><td  class="tabledata"><input type="password" name="repassword" class="input-text"/> </td></tr>
                          </table>
                          <div class="button-bar-container">
                                <div class="button-bar">
                                    ...
                                    <button id="createAccount1" class="ui-corner-all ui-button ui-widget" type="submit"><g:message code="com.sungardhe.banner.forgotpin.button.submit"/></button>
                                </div>
                          </div>
                       </form>
                  </div>
