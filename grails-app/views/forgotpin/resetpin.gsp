...
<html>
  <head>
      <title><g:message code="com.sungardhe.banner"/></title>
      ...
      <div class="ui-layout-center inner-content" id="inner-content">
          <div class="inner-center">
              <div id="forgotpin" class="ui-widget ui-widget-section">
                  <div class="ui-widget-header"> Reset Password </div>
                  <div class="main-wrapper" >
                      ...
                      <form action="${postBackUrl}" method="post" id="resetPinForm">
                          <table cellpadding="5" cellspacing="10" class="input-table">
                             ...
                             <tr><td class="tabledata" colspan="2">Enter your new password.</td></tr>
                             <tr><td class="tabletext"> New Password :</td><td class="tabledata"><input type="password" name="password" class="input-text"/> </td></tr>
                             <tr><td class="tabletext"> Re-enter New Password :</td><td  class="tabledata"><input type="password" name="repassword" class="input-text"/> </td></tr>
                          </table>
