...
<body>
    <div class="dialog-mask">
        <div class="dialog-wrapper">
            <div class="custom-logout-dialog" role="main">
                <g:if test="${show}">
                ...
                <g:if test="${logoutUri != null}">
                    ...
                    <div class="dialog-sign">
                        <input type="button" value="${g.message(code:'net.hedtech.banner.logout.action')}" class="common-button-primary" onclick='location.href="${targetLogout}"'/>
                        <input type="button" value="${g.message(code:'net.hedtech.banner.logout.backToHomeButton')}" class="common-button-primary" onclick='location.href="${targetHome}"' />
                    </div>
                </g:if>
