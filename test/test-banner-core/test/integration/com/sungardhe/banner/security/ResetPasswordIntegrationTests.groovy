...
class ResetPasswordIntegrationTests extends GroovyTestCase {
    ...
    private void dataSetup(){
        ...
        db.executeUpdate("""
                    ...
                    SELECT COUNT(GOBANSR_NUM) INTO LV_QUESTION_EXISTS_COUNT FROM gobansr WHERE GOBANSR_PIDM = LV_PIDM_ID and GOBANSR_NUM ='1';
                    ...
                    SELECT COUNT(GOBANSR_NUM) INTO LV_QUESTION_EXISTS_COUNT FROM gobansr WHERE GOBANSR_PIDM = LV_PIDM_ID and GOBANSR_NUM ='2';
                    ...
                    SELECT COUNT(GOBANSR_NUM) INTO LV_QUESTION_EXISTS_COUNT FROM gobansr WHERE GOBANSR_PIDM = LV_PIDM_ID and GOBANSR_NUM ='3';
