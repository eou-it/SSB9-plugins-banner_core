...
class ContainsOperatorIntegrationTests extends BaseIntegrationTestCase {

    private ContainsOperator containsOperator
    ...
    void testingContainsOperator(){
        ...
        def result = containsOperator.getQueryString(criteriaData)
