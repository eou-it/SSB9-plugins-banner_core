...
class DateLessThanEqualsOperatorIntegrationTests extends BaseIntegrationTestCase {

    private DateLessThanEqualsOperator dateLessThanEqualsOperator
    private CriteriaData criteriaData

    @Before
    public void setUp() {
        formContext = ['GUAGMNU']
        dateLessThanEqualsOperator = new DateLessThanEqualsOperator()
    ...
    @Test
    void testingDateLessThanEqualsOperator(){
        ...
        def result = dateLessThanEqualsOperator.getQueryString(criteriaData)
