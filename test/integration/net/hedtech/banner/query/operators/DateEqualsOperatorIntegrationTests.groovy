...
class DateEqualsOperatorIntegrationTests extends BaseIntegrationTestCase {

    private DateEqualsOperator dateEqualsOperator
    private CriteriaData criteriaData

    @Before
    public void setUp() {
        formContext = ['GUAGMNU']
        dateEqualsOperator = new DateEqualsOperator()
    ...
    @Test
    void testingDateEqualsOperator(){
        ...
        def result = dateEqualsOperator.getQueryString(criteriaData)
